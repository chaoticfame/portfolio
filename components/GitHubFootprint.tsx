  ...
  return (
    ...
    >
      <div className="mx-auto max-w-layout px-5 sm:px-8">
        ...
        <Reveal className="mb-4 grid grid-cols-2 gap-px overflow-hidden rounded-xl border border-neutral-800 bg-neutral-800/60 md:grid-cols-4">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1.4fr_1fr]">
          ...
          <Reveal className="flex flex-col gap-4">
            ...
            <div className="overflow-hidden rounded-xl border border-neutral-800 bg-neutral-950">
              <div className="flex items-center gap-2 border-b border-neutral-800 bg-neutral-900/40 px-4 py-2.5">
              ...
              <div className="scrollbar-thin max-h-64 overflow-y-auto p-4 font-mono text-xs leading-relaxed">
                {recentCommits.map((commit) => (
                  ...
                  >
                    <GitCommitHorizontal className="h-3.5 w-3.5 shrink-0 text-neutral-600" />
                    <span className="text-amber-500/80">{commit.hash}</span>
                    <span className="flex items-center gap-1 text-neutral-500">
                      <GitBranch className="h-3 w-3" />
                      {commit.branch}
                    </span>
                    <span className="text-neutral-300">{commit.message}</span>
                ...
                <div className="flex items-center gap-2 pt-2 text-neutral-500">
                  ...
                  <span className="inline-block h-3.5 w-2 animate-blink bg-neutral-500 align-middle" />
                </div>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal className="flex flex-col gap-4" delay={0.1}>
            {repoCards.map((repo) => (
              <a
                ...
                className="group flex flex-col rounded-xl border border-neutral-800 bg-neutral-900/20 p-5 transition-colors duration-300 hover:border-neutral-700 hover:bg-neutral-900/40"
              >
                ...
                <div className="mt-4 flex items-center gap-4 font-mono text-xs text-neutral-500">
